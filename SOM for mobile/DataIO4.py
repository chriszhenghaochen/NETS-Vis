...
labour_fri_1 = file_fri_1['user'].values.astype('str')
...
reload(sys.modules['sompy3'])

t0 = time.time()
sm = SOM.SOM(file, 'sm', Data, label,mapsize = [msz0, msz1],norm_method = 'var',initmethod='pca')
...
# #for map only
d = sm.view_U_matrix(distance2=2, row_normalized='No', show_data='Yes', contooor='Yes', blob='No', save='No', save_dir='',HCI = 'Yes',compare= 2)