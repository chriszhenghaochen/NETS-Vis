...
class SOM(object):
    ...
    def __init__(self,filename, name, Data, labels = None, mapsize = None, norm_method = 'var',initmethod = 'pca',neigh='Guassian'):
        """
            ...
            if compare == 0:
                ...
                for i in range(len(data)):
                    if lman1.data[i].color == Datum.colorin:
                        ...
                        bararr1.append(str(lman1.data[i].labour))
                ...
                for i in range(compare):
                    ...
                    for j in range(len(data)):
                        if lman.data[j].color == Datum.colorin:
                            # print lman1.data[i].labour
                            tmpname.append(str(lman.data[j].labour))
