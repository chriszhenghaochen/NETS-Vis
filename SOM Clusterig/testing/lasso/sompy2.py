...
class SOM(object):
    ...
    def __init__(self,name, Data, labels = None, mapsize = None, norm_method = 'var',initmethod = 'pca',neigh='Guassian'):
        """
...
#           plt.scatter(X, msz[0]-1-Y, s=area, alpha=0.9,c='None',marker='o',cmap='jet',linewidths=3, edgecolor = 'r')
    ...
    def view_U_matrix(self,distance2=1,row_normalized='No',show_data='Yes',contooor='Yes',blob = 'No',save='No',save_dir = '', text_show = 'No', write = 'No'):
        import scipy
...
#           umat[umat<=mn]=mn
        ...
        if show_data=='Yes':
            ...
            #modified
            if write == 'Yes':
                f = open('C:/Users/zchen4/Desktop/data/bmu.txt','w')
