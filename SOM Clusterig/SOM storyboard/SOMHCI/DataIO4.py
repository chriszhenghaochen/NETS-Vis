...
file = 'C:/Users/zchen4/Desktop/data/attraction frequency/sun_crime.csv'
...
# #for map only
d = sm.view_U_matrix(distance2=2, row_normalized='No', show_data='Yes', contooor='Yes', blob='No', save='No', save_dir='',HCI = 'Yes')