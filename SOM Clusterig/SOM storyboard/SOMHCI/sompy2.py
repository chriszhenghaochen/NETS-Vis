...
#           umat[umat<=mn]=mn
        ...
        if HCI == 'Yes':
            ...
            if compare == 0:
                ...
                f = open('C:/Users/zchen4/Desktop/data/outputlab.csv','w')
            ...
            #modified 4-2 if need compare produce complex barchart
                ...
                #write to a file
                f = open('C:/Users/zchen4/Desktop/data/outputlab1.csv','w')
                ...
                #write to a file
                f = open('C:/Users/zchen4/Desktop/data/outputlab2.csv','w')
